"""Revision incial, ya incluye los roles de usuario y modulos

Revision ID: 9b34c45200e4
Revises: 
Create Date: 2024-06-23 17:13:13.960118
...
def upgrade() -> None:
    ...
    sa.Column('sku', sa.Integer(), autoincrement=True, nullable=False),
    ...
    sa.Column('full_name', sa.String(length=50), nullable=False),
    sa.Column('age', sa.Integer(), nullable=False),
    sa.Column('whatsapp', sa.CHAR(length=10), nullable=False),
    sa.Column('username', sa.String(length=30), nullable=False),
    sa.Column('password', sa.String(length=50), nullable=False),
    sa.Column('role_id', sa.Integer(), nullable=False),
    sa.Column('theme_mode_id', sa.Integer(), nullable=False),
    sa.CheckConstraint('age >= 18'),
    sa.ForeignKeyConstraint(['role_id'], ['roles.id'], ),
    sa.ForeignKeyConstraint(['theme_mode_id'], ['theme_modes.id'], ),
    sa.PrimaryKeyConstraint('id'),
...
def downgrade() -> None:
    ...
    op.drop_table('users')
    op.drop_table('sales')
    op.drop_table('roles_modules')
    op.drop_table('purchases')
    op.drop_table('products')
    op.drop_table('units')
    op.drop_table('theme_modes')
